  ...
  return (
    <div className="flex text-sm rounded-3xl peer-checked:rounded-b-none min-h-0  py-0">
      ...
      <div className="flex-wrap collapse collapse-arrow">
        ...
        <div className="collapse-title text-success text-sm min-h-0 py-1.5 pl-1 after:!top-4">
          <strong>Transaction Receipt</strong>
        </div>
        <div className="collapse-content text-white overflow-auto  rounded-t-none rounded-3xl !pl-0">
